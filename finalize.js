...
const SUBTITLE='Técnico en instalación, reparación y mantenimiento de antenas, porteros automáticos y videoporteros';
...
function finalizeTown(d){
  ...
  h=h.replace(/(<div class="hero-copy">[\s\S]*?<h1>[\s\S]*?<\/h1>\s*<h2>)[\s\S]*?(<\/h2>)/i,`$1${SUBTITLE}$2`);
