...
function finalizeHome(){
  ...
  h=h.replace(/(<div class="copy">[\s\S]*?<h1>)[\s\S]*?(<\/h1>\s*<h2>)[\s\S]*?(<\/h2>)/i,'$1Antenista cerca de tu vivienda$2Instalación, reparación y mantenimiento de antenas, porteros automáticos y videoporteros$3');
