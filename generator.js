...
function businessSchema(){
  return {'@type':'Organization','@id':`${DOMAIN}/#negocio`,name:'Antenista Cerca',url:`${DOMAIN}/`,telephone:TEL};
}
...
function schema(d){
  ...
  return JSON.stringify({'@context':'https://schema.org','@graph':[
    ...
    {'@type':'Service','@id':`${url}#servicio`,name:`Antenista, reparación e instalación de antenas en ${d.localidad}`,provider:{'@id':`${DOMAIN}/#negocio`},telephone:TEL,serviceType:[
    ...
    {'@type':'BreadcrumbList',itemListElement:[
      ...
      {'@type':'ListItem',position:3,name:d.localidad,item:url}
    ]}
  ]});
}
...
function town(d){
  ...
  h=h.replace('<h2>Instalación, reparación y mantenimiento de antenas</h2>','<h2>Instalación, reparación y mantenimiento de antenas, porteros y videoporteros</h2>');
  h=h.replace('<div class="mobilebar"><a href="tel:+34641589394">Llamar</a><a href="https://wa.me/34641589394">WhatsApp</a></div>','<div class="mobilebar"><a href="tel:+34641589394">☎ 641 589 394</a><a href="https://wa.me/34641589394">WhatsApp</a></div>');
...
.portero-pair{display:grid;grid-template-columns:1fr 1fr;height:175px;background:#eef3f6}.portero-pair img{width:100%;height:175px;object-fit:cover;min-width:0}.portero-pair img+img{border-left:2px solid #fff}.brands-note{margin-top:12px;color:#536373;font-size:15px;line-height:1.6}
.direct-tech{margin-top:18px;display:flex;align-items:flex-start;gap:12px;padding:15px 16px;background:#eef5fa;border:1px solid #d8e5ee;border-left:4px solid #0a3f73;border-radius:10px;color:#394b5d;box-shadow:0 5px 14px rgba(16,45,72,.06)}.direct-tech .direct-icon{display:grid;place-items:center;flex:0 0 26px;width:26px;height:26px;border-radius:50%;background:#10ad3e;color:#fff;font-size:15px;font-weight:800}.direct-tech strong{display:block;color:#0a3f73;font-size:17px;line-height:1.2;margin:1px 0 4px}.direct-tech div>span{display:block;line-height:1.5}
@media(min-width:1000px){.wrap{width:min(1280px,calc(100% - 48px));max-width:1280px}.cards{grid-template-columns:repeat(3,minmax(0,1fr));gap:18px}.card img{height:175px}}
@media(max-width:900px){.cards{grid-template-columns:repeat(2,minmax(0,1fr))}.twocol{grid-template-columns:1fr!important;gap:14px}.twocol .sidebox{width:100%;margin-top:0}}
@media(max-width:640px){.cards{grid-template-columns:repeat(2,minmax(0,1fr));gap:10px}.card>img,.portero-pair,.portero-pair img{height:116px}.twocol{grid-template-columns:1fr!important;gap:12px;padding:26px 0}.twocol .sidebox{width:100%;margin-top:4px;padding:16px}.twocol .sidebox strong{font-size:18px}.brands-note{font-size:13px}.direct-tech{padding:13px 12px;gap:10px}.direct-tech strong{font-size:15px}.direct-tech div>span{font-size:13px}}
</style></head>`);
...
function province(p,slug,items){
  ...
  return `<!doctype html><html lang="es"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1,viewport-fit=cover"><meta name="robots" content="noindex,nofollow"><title>Antenistas y reparación de antenas en ${esc(p)} | ${PHONE}</title><meta name="description" content="Técnicos de antenas en municipios de ${esc(p)} para instalación y reparación de antenas TDT, parabólicas, amplificación, porteros y videoporteros. Teléfono ${PHONE}."><link rel="canonical" href="${DOMAIN}/${slug}/"><script type="application/ld+json">${JSON.stringify({'@context':'https://schema.org','@graph':[businessSchema(),{'@type':'CollectionPage',url:`${DOMAIN}/${slug}/`,name:`Antenistas en ${p}`,about:{'@id':`${DOMAIN}/#negocio`}}]})}</script><style>:root{--b:#0a3f73;--d:#082b4d;--l:#dce5ec;--r:#d92128;--g:#10ad3e;--s:#f4f8fb}*{box-sizing:border-box}body{font:16px Arial,Helvetica,sans-serif;margin:0;color:#10243a;line-height:1.55;-webkit-font-smoothing:antialiased}.w{width:min(1280px,calc(100% - 48px));margin:auto;padding:34px 0}a{color:var(--b);text-decoration:none}.back{font-weight:700}.grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(190px,1fr));gap:11px;margin-top:22px}.grid a{padding:13px 14px;border:1px solid var(--l);border-radius:9px;font-weight:700;background:#fff;box-shadow:0 3px 10px rgba(16,45,72,.04)}h1{color:var(--b);font-size:40px;line-height:1.05;margin-bottom:12px}.lead{color:#536373;max-width:920px;line-height:1.65}.direct-province{display:flex;gap:10px;align-items:center;margin:18px 0;padding:13px 14px;background:#eef5fa;border-left:4px solid var(--b);border-radius:9px;color:var(--b);font-weight:700}.direct-province i{display:grid;place-items:center;width:24px;height:24px;border-radius:50%;background:var(--g);color:#fff;font-style:normal}.mobilebar{display:none}@media(max-width:640px){body{padding-bottom:calc(62px + env(safe-area-inset-bottom))}.w{width:min(100% - 22px,1280px)}h1{font-size:34px}.mobilebar{display:grid;grid-template-columns:1fr 1fr;position:fixed;bottom:0;left:0;right:0;z-index:80;box-shadow:0 -4px 14px rgba(8,43,77,.14);padding-bottom:env(safe-area-inset-bottom);background:#fff}.mobilebar a{padding:15px;text-align:center;color:#fff!important;font-weight:800;background:var(--r)}.mobilebar a:last-child{background:var(--g)}}</style></head><body><main class="w"><p><a class="back" href="/">← Inicio</a></p><h1>Técnicos de antenas en ${esc(p)}</h1><p class="lead">Técnico de antenas y antenista para reparación e instalación de antenas de TV y TDT, amplificadores y cabeceras, porteros automáticos y videoporteros, soluciones de cobertura móvil y reparaciones eléctricas del hogar.</p><div class="direct-province"><i>✓</i><span>Trato directo con el técnico desde el primer contacto, sin centralitas ni intermediarios.</span></div><div class="grid">${links}</div></main><div class="mobilebar"><a href="tel:${TEL}">☎ ${PHONE}</a><a href="https://wa.me/${WA}">WhatsApp</a></div></body></html>`;
}
...
function homeSchema(){
  return JSON.stringify({'@context':'https://schema.org','@graph':[businessSchema(),{'@type':'WebSite','@id':`${DOMAIN}/#website`,url:`${DOMAIN}/`,name:'Antenista Cerca',publisher:{'@id':`${DOMAIN}/#negocio`}}]});
}
...
function home(){
  ...
  return `<!doctype html><html lang="es"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1,viewport-fit=cover"><meta name="robots" content="noindex,nofollow"><title>Antenista Cerca | Reparación e instalación de antenas | ${PHONE}</title><meta name="description" content="Antenista Cerca: instalación y reparación de antenas TDT y parabólicas, amplificación, porteros y videoporteros. Trato directo con el técnico. Teléfono ${PHONE}."><link rel="canonical" href="${DOMAIN}/"><script type="application/ld+json">${homeSchema()}</script><style>:root{--b:#0a3f73;--d:#082b4d;--r:#d92128;--g:#10ad3e;--l:#dce5ec;--s:#f4f8fb;--sh:0 12px 30px rgba(16,45,72,.10)}*{box-sizing:border-box}body{margin:0;font-family:Arial,Helvetica,sans-serif;color:#10243a;line-height:1.55;-webkit-font-smoothing:antialiased;text-rendering:optimizeLegibility}a{text-decoration:none;color:inherit}.w{width:min(1280px,calc(100% - 48px));margin:auto}.top{background:var(--d);color:#fff;font-size:13px;padding:7px 0}.top .w{display:flex;justify-content:space-between}.head{display:grid;grid-template-columns:1fr auto auto;align-items:center;gap:22px;padding:12px 0}.brand{display:flex;gap:10px;align-items:center}.brand .ico{font-size:34px}.brand strong{font-size:27px;line-height:1;color:var(--b)}.brand strong span{color:#8b8b8b}.brand small{display:block;font:italic 14px Georgia;color:var(--b);margin-top:2px}nav{display:flex;gap:20px;font-weight:700;font-size:14px}.tel{font-size:24px;color:var(--r);font-weight:800;white-space:nowrap}.hero{background:linear-gradient(90deg,#fbfdff 0,#edf6fc 48%,#dceef9 100%)}.hg{display:grid;grid-template-columns:1fr 1.03fr;min-height:420px}.copy{align-self:center;padding:38px 28px 34px 0}.kicker{font-size:12px;font-weight:800;letter-spacing:.12em;color:var(--b);text-transform:uppercase;margin-bottom:6px}.urgent{display:inline-flex;margin:0 0 12px;padding:7px 10px;border-radius:999px;background:#fff3f3;color:#b81319;font-size:13px;font-weight:800;border:1px solid #ffd7d9}.copy h1{font-size:52px;line-height:1;margin:0 0 12px;color:#0b3765;letter-spacing:-.02em}.copy h2{font-size:23px;line-height:1.2;margin:0 0 15px}.checks{list-style:none;padding:0;margin:0 0 19px}.checks li{margin:7px 0;font-size:16px}.checks li:before{content:'✓';display:inline-grid;place-items:center;width:19px;height:19px;border-radius:50%;background:var(--g);color:#fff;font-weight:bold;margin-right:8px}.actions{display:flex;gap:12px;flex-wrap:wrap}.btn{display:inline-flex;align-items:center;justify-content:center;border-radius:9px;color:#fff;font-weight:800;padding:12px 17px;line-height:1.15}.hero .actions .btn{min-width:190px;font-size:19px}.red{background:var(--r)}.green{background:var(--g)}.heroimg{overflow:hidden;min-height:420px;background:#dce8f0}.heroimg img{width:100%;height:100%;object-fit:cover}.section{padding:38px 0}.section h2{font-size:30px;line-height:1.15;margin:0 0 7px;color:var(--b);letter-spacing:-.01em}.service-lead{max-width:940px;color:#536373}.service-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:18px;margin-top:22px}.service-grid article{border:1px solid #e3ebf1;border-radius:15px;overflow:hidden;background:#fff;box-shadow:var(--sh)}.service-grid>article>img{width:100%;height:175px;object-fit:cover;background:#eef3f6}.home-pair{height:175px}.home-pair img{height:175px}.service-grid article>div:not(.portero-pair){padding:16px}.service-grid h3{margin:0 0 7px;color:var(--b);font-size:19px;line-height:1.2}.service-grid p{margin:0;color:#536373;font-size:14px;line-height:1.5}.brand-list{margin-top:10px!important;color:var(--b)!important;font-size:13px!important;font-weight:800}.brands-strip{margin-top:22px;padding:15px 17px;border:1px solid var(--l);border-radius:12px;background:#f7fafc;display:flex;flex-wrap:wrap;gap:7px 18px;color:#536373;font-size:14px}.brands-strip strong{color:var(--b)}.extra-services{margin-top:20px;padding-top:18px;border-top:1px solid var(--l);color:#536373;line-height:1.7}.extra-services strong{display:block;color:var(--b);font-size:18px;margin-bottom:4px}.extra-services p{margin:0}.portero-pair{display:grid;grid-template-columns:1fr 1fr;background:#eef3f6}.portero-pair img{width:100%;object-fit:cover;min-width:0}.portero-pair img+img{border-left:2px solid #fff}.zones{background:var(--s)}.area{margin:20px 0;padding:18px 20px;background:#fff;border:1px solid var(--l);border-left:4px solid var(--b);border-radius:12px;box-shadow:0 5px 14px rgba(16,45,72,.05)}.areahead{display:flex;justify-content:space-between;align-items:center;gap:18px}.areahead h3{color:var(--b);margin:0;font-size:20px}.areahead a{color:var(--b);font-weight:800}.towns{display:grid;grid-template-columns:repeat(4,1fr);gap:10px 12px;margin-top:16px}.towns a{background:#f9fbfd;border:1px solid var(--l);padding:11px 12px;border-radius:9px;color:var(--b);font-weight:700;transition:.15s}.towns a:hover{background:#eef5fa;border-color:#cbdce8}.local{display:grid;grid-template-columns:.92fr 1.08fr;gap:30px;align-items:center}.local img{width:100%;height:300px;object-fit:cover;border-radius:14px;box-shadow:var(--sh)}.direct-home{display:flex;align-items:flex-start;gap:12px;margin-top:18px;padding:15px 16px;background:#eef5fa;border:1px solid #d8e5ee;border-left:4px solid var(--b);border-radius:10px;color:#394b5d;box-shadow:0 5px 14px rgba(16,45,72,.06)}.direct-home i{display:grid;place-items:center;flex:0 0 26px;width:26px;height:26px;border-radius:50%;background:var(--g);color:#fff;font-style:normal;font-weight:800}.direct-home strong{display:block;color:var(--b);font-size:17px;margin-bottom:4px}.cta{background:var(--b);color:#fff;padding:26px;border-radius:12px}.cta h2{color:#fff}footer{background:var(--d);color:#fff;padding:24px 0;margin-top:34px}.mobilebar{display:none}@media(max-width:850px){nav{display:none}.head{grid-template-columns:1fr auto}.hg,.local{grid-template-columns:1fr}.copy{padding:28px 0 20px}.heroimg{height:300px;min-height:300px}.service-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.towns{grid-template-columns:1fr 1fr}}@media(max-width:520px){body{padding-bottom:calc(62px + env(safe-area-inset-bottom))}.w{width:min(100% - 22px,1280px)}.top{display:none}.brand .ico{font-size:28px}.brand strong{font-size:18px}.brand small{font-size:11px}.tel{font-size:16px}.copy h1{font-size:40px}.copy h2{font-size:19px}.service-grid{gap:10px}.service-grid>article>img,.home-pair,.home-pair img{height:116px}.service-grid article>div:not(.portero-pair){padding:11px}.service-grid h3{font-size:16px}.service-grid p{font-size:12px}.brand-list{font-size:11px!important}.brands-strip{display:block}.brands-strip span{display:block;margin-top:5px}.extra-services{font-size:13px}.extra-services strong{font-size:16px}.area{padding:15px 13px}.areahead h3{font-size:18px}.hero .actions .btn{min-width:140px;flex:1;font-size:16px}.direct-home{padding:13px 12px}.direct-home strong{font-size:15px}.mobilebar{display:grid;grid-template-columns:1fr 1fr;position:fixed;bottom:0;left:0;right:0;z-index:80;box-shadow:0 -4px 14px rgba(8,43,77,.14);padding-bottom:env(safe-area-inset-bottom);background:#fff}.mobilebar a{padding:15px;text-align:center;color:#fff;font-size:15px;font-weight:800;background:var(--r)}.mobilebar a:last-child{background:var(--g)}}</style></head><body><div class="top"><div class="w"><span>Antenas TDT · Parabólicas · Porteros automáticos · Cobertura móvil</span><span>Urgencias 24 horas</span></div></div><header><div class="w head"><a class="brand" href="/"><span class="ico">📡</span><span><strong>ANTENISTA <span>CERCA</span></strong><small>Tu antenista de confianza</small></span></a><nav><a href="#servicios">Servicios</a><a href="#zonas">Zonas</a><a href="#contacto">Contacto</a></nav><a class="tel" href="tel:${TEL}">☎ ${PHONE}</a></div></header><main><section class="hero"><div class="w hg"><div class="copy"><div class="kicker">Técnico de antenas cerca de ti</div><div class="urgent">Urgencias 24 horas</div><h1>Antenista cerca de ti</h1><h2>Instalación, reparación y mantenimiento de antenas, porteros y videoporteros</h2><ul class="checks"><li>Averías y falta de señal</li><li>Antenas TDT y parabólicas</li><li>Porteros automáticos y videoporteros</li><li>Viviendas, comunidades y negocios</li></ul><div class="actions"><a class="btn red" href="tel:${TEL}">☎ ${PHONE}</a><a class="btn green" href="https://wa.me/${WA}">WhatsApp</a></div></div><div class="heroimg"><img src="${HERO}" alt="Técnico de antenas trabajando"></div></div></section>${services}<section id="zonas" class="section zones"><div class="w"><h2>Encuentra un técnico de antenas en tu municipio</h2><p>Elige tu municipio para consultar el servicio disponible y las localidades próximas.</p>${areas}</div></section><section class="section"><div class="w local"><img src="${TOWN}" alt="Zona de servicio"><div><h2>Un antenista cerca cuando lo necesitas</h2><p>Atendemos averías de señal, instalaciones TDT y parabólicas, amplificación, porteros automáticos y videoporteros, cobertura móvil y pequeñas reparaciones eléctricas.</p><div class="direct-home"><i>✓</i><div><strong>Trato directo con el técnico</strong><span>Te atiende una persona que conoce el trabajo desde el primer contacto, sin centralitas ni intermediarios.</span></div></div></div></div></section><section id="contacto" class="section"><div class="w cta"><h2>¿Necesitas un técnico?</h2><p>Urgencias 24 horas. Cuéntanos la avería o instalación que necesitas.</p><div class="actions"><a class="btn red" href="tel:${TEL}">☎ ${PHONE}</a><a class="btn green" href="https://wa.me/${WA}">WhatsApp</a></div></div></section></main><footer><div class="w"><strong>Antenista Cerca</strong> · ${PHONE}</div></footer><div class="mobilebar"><a href="tel:${TEL}">☎ ${PHONE}</a><a href="https://wa.me/${WA}">WhatsApp</a></div></body></html>`;
}
