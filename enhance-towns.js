...
for(const d of localidades){
  ...
  const gallery=`<div class="old-doorphones"><div class="old-doorphones-grid"><figure><img src="/assets/portero-antiguo-1.jpg" loading="lazy" alt="Placa de portero automático antigua para reparar o renovar en ${d.localidad}"></figure><figure><img src="/assets/portero-antiguo-2.jpg" loading="lazy" alt="Portero automático Fermax antiguo para reparación o sustitución en ${d.localidad}"></figure><figure><img src="/assets/portero-antiguo-3.jpg" loading="lazy" alt="Placa de portero Tegui antigua para reparar o cambiar por videoportero en ${d.localidad}"></figure></div><div class="old-doorphones-copy"><strong>¿Tienes un portero antiguo?</strong><p>Reparamos placas de calle, telefonillos, pulsadores, fuentes y cableado. Si el sistema está obsoleto, también podemos renovarlo o sustituirlo por un portero o videoportero actual.</p></div></div>`;
  if(!h.includes('class="old-doorphones"')){
    h=h.replace(/(<section class="band" id="porteros">[\s\S]*?<h2>Instalación, reparación y renovación de porteros automáticos y videoporteros en [^<]+<\/h2>[\s\S]*?<p>[^<]*<\/p>)/i,`$1${gallery}`);
  }
  ...
  h=h.replace(/(<section class="band" id="porteros">[\s\S]*?)<p class="brands-note">[\s\S]*?<\/p>/i,`$1${brands}`);

  const ampGallery=`<div class="amp-gallery"><div class="amp-grid"><figure><img src="/assets/amplificador-alcad-interior.jpg" loading="lazy" alt="Amplificador de interior Alcad para antena en ${d.localidad}"></figure><figure><img src="/assets/amplificador-alcad-mastil.jpg" loading="lazy" alt="Amplificador de mástil Alcad para antena TDT en ${d.localidad}"></figure><figure><img src="/assets/amplificador-televes.jpg" loading="lazy" alt="Amplificador Televés para reparación de antena en ${d.localidad}"></figure><figure><img src="/assets/amplificador-satelite-rover-ek.jpg" loading="lazy" alt="Amplificador y equipo de satélite Rover EK en ${d.localidad}"></figure></div><div class="amp-copy"><strong>Reparación y sustitución de amplificadores</strong><p>Reparamos amplificadores de interior y de mástil, fuentes de alimentación, centrales de amplificación y equipos de satélite. Revisamos primero la avería para sustituir únicamente lo necesario.</p></div></div>`;
  ...
  h=h.replace(/(<section class="band" id="reparacion">[\s\S]*?)<p class="brands-note">[\s\S]*?<\/p>/i,`$1${ampGallery}${antennaBrands}`);
  ...
  // CSS compartido: una sola copia cacheable para todas las localidades.
  h=h.replace(/<style id="shared-ui">[\s\S]*?<\/style>/i,'<link rel="stylesheet" href="/assets/shared-ui.css">');
  if(!h.includes('/assets/town-enhancements.css')){
    h=h.replace('</head>','<link rel="stylesheet" href="/assets/town-enhancements.css"></head>');
  }
